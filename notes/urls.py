...
urlpatterns = [
    ...
    # 查询图书评分
    re_path(r'^query_book/comment.svg$', behavior_comment_svg, name='comment_svg'),
    ...
    # 用户行为分析啊散点图
    re_path(r'^behavior_analysis/analysisSD.svg$', behavior_analysisSD_svg, name='behavior_analysisSD_svg'),
]
