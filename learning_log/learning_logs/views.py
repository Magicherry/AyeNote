    ...
    if request.method == 'GET':
        ...
        if form.is_valid():
            ...
            chart.render_to_file(
                'learning_logs/templates/learning_logs/bookZan.svg')
            ...
            for a in data4:
                ...
                idx -= 1
            pie_chart.render_to_file('learning_logs/templates/learning_logs/comment.svg')
...
def behavior_comment_svg(request):
    return render(request, 'learning_logs/comment.svg', {})
...
def behavior_analysis_views(request):
    ...
    chart.add('', num)
    chart.render_to_file('learning_logs/templates/learning_logs/analysis.svg')
    ...
    chartSD.render_to_file('learning_logs/templates/learning_logs/analysisSD.svg')  # 保存为SVG文件
...
def behavior_analysisSD_svg(request):
    return render(request, 'learning_logs/analysisSD.svg', {})
